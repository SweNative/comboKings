...
export default class gameView extends Component {
  ...
  saveHighScore() {
    AsyncStorage.setItem("highScore", String(this.state.highScore));
  }

  getHighScore = async () => {
    try {
      let highScoreString = await AsyncStorage.getItem("highScore");
      if (highScoreString != null) {
        let highScore = parseInt(highScoreString, 10);
  ...
  render() {
    return this.state.hasNotStarted ? (
